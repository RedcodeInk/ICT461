  ...
  <head>
    ...
    <!--link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet"-->
     ...
     <style>
        body
        {
            background-image: url(https://i1.wp.com/www.sidneyblake.com/wp-content/uploads/2015/05/golden-wheat-crop-alberta-agriculture-5675.jpg?fit=1100%2C733&ssl=1);
                                ...
                                <?php 
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $cropf)
                                        {
                                            ...
                                            <tr>
                                                <td><?= $cropf['CropFieldID']; ?></td>
                                                <td><?= $cropf['Humidity']; ?></td>


                                                <td>
                                                    <a href="field-view.php?id=<?= $cropf['Humidity']; ?>" class="btn btn-info btn-sm">View</a>
                                                    <a href="field-edit.php?id=<?= $cropf['Humidity']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="code.php" method="POST" class="d-inline">
                                                        <button type="submit" name="delete_field" value="<?=$cropf['CropFieldID'];?>" class="btn btn-danger btn-sm">Delete</button>
                                                    </form>
                                                </td>
